...
class API_0: public API {
 ...
 private:
     ...
     * and reciprocally.
     */
    static bool from_to(const app::Nic &nic_model, MessageV0_Nic *nic_message);
    static bool from_to(const MessageV0_Nic &nic_message, app::Nic *nic_model);
    static bool from_to(const MessageV0_NicUpdateReq &nic_update_message,
                        API::NicUpdate *nic_update_model);
    static bool from_to(const app::Sg &sg_model, MessageV0_Sg *sg_message);
    static bool from_to(const MessageV0_Sg &sg_message, app::Sg *sg_model);
    static bool from_to(const app::Rule &rule_model,
                        MessageV0_Rule *rule_message);
    static bool from_to(const MessageV0_Rule &rule_message,
                        app::Rule *rule_model);
    static bool from_to(const app::Ip &ip_model, std::string *ip_message);
    static bool from_to(const std::string &ip_message, app::Ip *ip_model);
    static bool from_to(const app::Mac &mac_model, std::string *mac_message);
    static bool from_to(const std::string &mac_message, app::Mac *mac_model);
    static bool from_to(const app::Cidr &cidr_model,
                        MessageV0_Cidr *cidr_message);
    static bool from_to(const MessageV0_Cidr &cidr_message,
                        app::Cidr *cidr_model);
    static bool from_to(const app::Error &error_model,
