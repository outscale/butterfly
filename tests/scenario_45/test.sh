...
network_connect 0 1
for big in {server_start_options+,server_start_options\ -t+}{nic_add+,nic_add_bypass+}{nic_add+,nic_add_bypass+}{nic_add+,nic_add_bypass+} ; do
    _server_start=$(echo $big | cut -d '+' -f 1)
